    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a 
                href="mailto:skmdtousif172@gmail.com" 
                aria-label="Email"
                target="_blank" 
              ...
              <a 
                href="https://github.com/skmd-tousif" 
                aria-label="GitHub"
                target="_blank" 
                rel="noopener noreferrer"
              >
              ...
              <a 
                href="https://codeforces.com/profile/sm_tousif21" 
              ...
              <a 
                href="https://www.linkedin.com/in/sk-md-tousif-2a1b30257/" 
                aria-label="LinkedIn"
                target="_blank" 
                rel="noopener noreferrer"
              >
        ...
        <div className="footer-bottom">
          <p>&copy; {currentYear} Sk Md Tousif. All rights reserved.</p>
